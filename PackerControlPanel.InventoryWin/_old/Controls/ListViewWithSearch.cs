...
{
    public partial class ListViewWithSearch : UserControl
    {
        /// <summary>
        ...
        public RadioButton AscendingRBTN
        {
            get { return this.AscendingBTN; }
            set { this.AscendingBTN = value; }
        }

        public RadioButton DesendingRBTN
        {
            get { return this.DescendingBTN; }
            set { this.DescendingBTN = value; }
        }
        ...
        {
            int top = (this.panel1.Top + this.panel1.Height + 20);

            this.ListView.Width = this.Width - 20;
            this.ListView.Height = (this.Height - top);
            this.ListView.Top = (this.panel1.Top + this.panel1.Height + 20);
            this.ListView.Height = this.Height - top;
        ...
        {
            AscendingBTN.Checked = false;
            DescendingBTN.Checked = true;
